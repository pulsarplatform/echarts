...
class LegendView extends ComponentView {
      ...
      if (seriesModel) {
        ...
        ecModel.eachRawSeries(function (seriesModel) {
          ...
          if (seriesModel.legendVisualProvider) {
            ...
            const itemGroup = this._createItem(seriesModel, name, dataIndex, legendItemModel, legendModel, itemAlign, {}, style, legendIcon, selectMode, api);
  ...
  _createItem(seriesModel, name, dataIndex, legendItemModel, legendModel, itemAlign, lineVisualStyle, itemVisualStyle, legendIcon, selectMode, api) {
