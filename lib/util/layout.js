 ...
 * @public
 */
export const LOCATION_PARAMS = ['left', 'right', 'top', 'bottom', 'width', 'height'];
/**
 * @public
 */
export const HV_NAMES = [['width', 'left', 'right'], ['height', 'top', 'bottom']];
...
export function positionElement(el, positionInfo, containerRect, margin, opt, out) {
  ...
  const layoutRect = getLayoutRect(zrUtil.defaults({
    width: rect.width,
    height: rect.height
